...
namespace IMS.BL.InventoryDBDataSetTableAdapters {
    ...
    public partial class UserAccountTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[UserAccount] WHERE (([UserId] = @Original_UserId) AND ([Userna" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[UserAccount] ([Username], [Password]) VALUES (@Username, @Pass" +
                "word);\r\nSELECT UserId, Username, Password FROM UserAccount WHERE (UserId = SCOPE" +
                "_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[UserAccount] SET [Username] = @Username, [Password] = @Password WHERE (([UserId] = @Original_UserId) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password));
SELECT UserId, Username, Password FROM UserAccount WHERE (UserId = @UserId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::IMS.BL.Properties.Settings.Default.InventoryDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserId, Username, Password FROM dbo.UserAccount";
        ...
        public virtual int Fill(InventoryDBDataSet.UserAccountDataTable dataTable) {
        ...
        public virtual InventoryDBDataSet.UserAccountDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            InventoryDBDataSet.UserAccountDataTable dataTable = new InventoryDBDataSet.UserAccountDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(InventoryDBDataSet.UserAccountDataTable dataTable) {
